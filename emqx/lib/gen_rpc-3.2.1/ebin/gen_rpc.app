{application,gen_rpc,
             [{description,"A scalable RPC library for Erlang-VM based languages"},
              ...
              {modules,[gen_rpc,gen_rpc_acceptor,gen_rpc_acceptor_sup,
                        gen_rpc_app,gen_rpc_auth,gen_rpc_client,
                        gen_rpc_client_config,gen_rpc_client_sup,
                        gen_rpc_dispatcher,gen_rpc_driver,gen_rpc_driver_ssl,
                        gen_rpc_driver_tcp,gen_rpc_helper,gen_rpc_keepalive,
                        gen_rpc_registry,gen_rpc_server,gen_rpc_sup]}]}.
