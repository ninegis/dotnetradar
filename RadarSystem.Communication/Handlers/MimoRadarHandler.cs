...
namespace RadarSystem.Communication.Handlers
{
    ...
    /// 协议: 5A5A/3C3C
    /// </summary>
    public class MimoRadarHandler : RadarHandlerBase<MimoRadarData>
    {
        public MimoRadarHandler(
            ILogger<MimoRadarHandler> logger,
            string projectId,
            string dataPath)
        ...
        protected override string DeviceTypeName => "MIMO Radar";
